-- ============================================
-- CORREÇÃO COMPLETA - Execute no Supabase SQL Editor
-- ============================================
...
-- 2. STORAGE POLICIES (limpar e recriar)
...
-- 3. TABELA CORRETORAS - Policies RLS (UPDATE/INSERT para authenticated)
...
-- UPDATE: corretora autenticada pode atualizar SUA PRÓPRIA linha (auth_user_id = auth.uid())
...
-- INSERT: admin pode criar corretoras (opcional, se precisar)
